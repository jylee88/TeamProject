...
<c:forEach var="product" items="${ProductList }">
    ...
    <td>
       ...
       <button type="button" onclick="location.href='ProductUpdate?pd_number=${product.pd_number }'">상품 수정</button><br>
       <button type="button" onclick="location.href='ProductDelete?pd_number=${product.pd_number }'">상품 삭제</button>
       </c:if>
    </td>
    </tr>
</c:forEach>
