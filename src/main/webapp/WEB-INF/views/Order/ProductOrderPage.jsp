...
<style>
   ...
   <form action="${contextPath}/Order/ProductOrderComplete" method="POST">
      ...
      <table class="table">
         ...
         <tr>
            ...
            <td class="td_order2">
               <input type="text" name="mb_ad1" value=${member.mb_ad1 } class="OrderPage_text" style="width : 275px;">
               ...
               <input type="text" name="mb_ad2" value=${member.mb_ad2 } class="OrderPage_text"><br>
               <input type="text" name="mb_ad3" value=${member.mb_ad3 } class="OrderPage_text"></td>
         </tr>
         <tr>
            <td class="td_order1">휴대폰 번호</td>
            <td class="td_order2" colspan="3">
            ...
            <td class="td_order1" style="height : 50px; text-align : center; border-bottom: 2px solid;">도착예정 날짜 : ${deliveryDay}</td>
         		...
         		<tr>
	               ...
	               <div class="OrderPage_div">
	                  <img src="${contextPath}/resources/upload/${product.pd_img}" style="width:15%;">
	                  ${product.pd_name } 1개 
					  <c:choose>
					  	<c:when test="${delivery < 20000 }">
					  		<c:set var="delivery" value="${delivery = 3000 }" />
					  	 </c:when>
					  	<c:otherwise>
					  		<c:set var="delivery" value="${delivery = 0 }" />
					  	</c:otherwise>
					  </c:choose>
	                  ${delivery }원 <br>
	                  <input type="hidden" name="pd_number" value=${product.pd_number }>
	                  <input type="hidden" name="od_delivery" value=${delivery }>
	                  <c:set var="sum1" value="${product.pd_price}" />  
	               </div>
	               </td>
	            </tr>
      </table>
      ...
      <table class="table">
         <tr>
            ...
            <td class="td_order2">${product.pd_price}원</td>
         </tr>
         <tr>
