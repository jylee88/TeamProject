            ...
            $.ajax({
               ...
               $("#submit").on("click",function(){
                  ...
                  if(!getPw.test($("#mb_pw").val())){ 
                     alert("5자리 이상의 숫자,영문자,특수문자 1개를 포함한 비밀번호를 입력해주세요"); 
                     $("#mb_pw").focus(); 
      ...
      <div class = "bob_content">
         ...
         <form style="text-align:center" method="post">
            <hr><br><br><br>
               ...
               <br><input type="password" name="mb_pw" id="mb_pw" placeholder="비밀번호" style="width:330px; height:40px;" maxlength="12"><br>
               <br><input type="password" name="mb_pwcheck" id="mb_pwcheck" placeholder="비밀번호 확인" style="width:330px; height:40px;" maxlength="12"><br>
