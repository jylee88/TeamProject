	...
	<div class = "bob_content">
		...
		<h1 class="mt-4">INPUT YOUR INFORMATION</h1><br>
			...
			<form style="text-align:center" method="post">
				...
				<br><input type="password" name="mb_pw" id="mb_pw" placeholder="비밀번호" style="width:330px; height:40px;" maxlength="5"><br>
				<br><input type="password" id="mb_pwcheck" placeholder="비밀번호 확인" style="width:330px; height:40px;" maxlength="5"><br>
